...
#define IMAGE_PAD_PERSENT_DEPLOY 0.05

#define CASCADE_FILE_PATH "/home/pouya/Develop/opencv-2.4.13/data/haarcascades_GPU/haarcascade_frontalface_alt2.xml"

#define NET_PATH_CLASSIFIER "/home/pouya/Develop/workspace/MLP_Train/src/deploy_.prototxt"
#define NET_WEIGHTS_CLASSIFIER	"/home/pouya/Develop/workspace/MLP_Train/src/weights/classifier_layer_iter_100.caffemodel"

#define NET_PATH_VGG "/home/pouya/Develop/caffe_old/models/vgg_face_caffe/deploy_50.prototxt"
#define NET_WEIGHTS_VGG	"/home/pouya/Develop/caffe_old/models/vgg_face_caffe/VGG_FACE.caffemodel"

#define LABEL_FILE	"/home/pouya/Develop/caffe_old/data/classes2.txt"
#define MEAN_FILE "/home/pouya/Develop/caffe_old/data/ilsvrc12/imagenet_mean.binaryproto"
#define MLP_PATH "mlp_weights.xmls"
#define ROI_X 0
#define ROI_Y 0
...
FeatureExtractorVGG feature_extractor;
FaceIdentifierSystem::Classifier classifier;
CvANN_MLP mlp;
...
vx_status VX_CALLBACK face_identication_process(vx_node node,
	...
	if (detected_faces > 0) {
		...
		for (int idx = 0; idx < detected_faces; idx++) {
            ...
            const float* features = feature_extractor.GetFeaturesDeploy(output);
            FaceIdentifierSystem::Prediction p =classifier.Classify(features) ;
